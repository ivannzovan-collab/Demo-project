/* ReelSaga — content data. Plain JS, exported to window. */
  ...
  const titles = [
    // ---------------- FIGMA HERO/ORIGINALS COVERS (real art) ----------------
    {
      ...
      // Hover/scroll trailer preview → https://videos.nanobitgames.com/trailers/{type}/{id}/{kind}.mp4
      //   type: 'Anime' | 'Shorts'  ·  id: the story id  ·  kind: 'TRAILER_720' | 'TEASER_720'
      // Add a `video` field to any title to enable its card trailer. Demo IDs are real: Anime/104, Shorts/125.
